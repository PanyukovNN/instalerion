...
public class InstagramRatedStoryPublishingStrategy extends InstagramBaseStoryPublishingStrategy {

    private final PostService postService;

    public InstagramRatedStoryPublishingStrategy(PostService postService,
    ...
    protected Post definePost(PublishingRequest request) {
        // TODO create algorithm to find most rated story
        return null;
    }
}
